...
const mutations = {
  [types.SET_APPLY_DATA] ({ applyData }, payload) {
    ...
    applyData.extension.eleven = payload.extension11 ? payload.extension11.classNum : null
    applyData.extension.twelve = payload.extension12 ? payload.extension12.classNum : null
  },
